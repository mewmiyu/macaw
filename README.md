...
```
cd existing_repo
git remote add origin https://git.rwth-aachen.de/dennis.hoebelt/macaw.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.rwth-aachen.de/dennis.hoebelt/macaw/-/settings/integrations)
